...
(function initPaddoxNativeNavigation(){
  ...
  const ROUTE_ASSETS = {
    ...
    'account.html': [
      ...
      'account-live-features.css?v=ACC_LIVE_1',
      ...
      'account-live-features.js?v=ACC_LIVE_1',
  ...
  function loadAccount2Safe(){
    ...
    const start = () => {
      ...
      const boot = () => {
        ...
        appendStylesheet('pdx-account-live-style', 'account-live-features.css?v=ACC_LIVE_1');
        ...
        appendScript('script[data-pdx-account-live]', 'account-live-features.js?v=ACC_LIVE_1', 'pdxAccountLive');
      };
