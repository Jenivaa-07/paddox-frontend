  ...
  tbody.innerHTML =
    products.map(product => {
      ...
      const image =
        ...
        'assets/paddox-logo-icon-web.png?v=A4_10C_3';
...
function renderInventory() {
  ...
  tbody.innerHTML = products.map((product, filteredIndex) => {
    ...
    const image = product.images?.[0]?.url || product.image || 'assets/paddox-logo-icon-web.png?v=A4_10C_3';
...
const ADMIN_POLL_FALLBACK_LOGOS = ADMIN_POLL_REAL_TEAM_LOGOS.map(team => ({
  ...
  { name:'PADDOX', slug:'paddox', color:'#e8002d', image:'assets/paddox-logo-icon-web.png?v=A4_10C_3' }
]);
