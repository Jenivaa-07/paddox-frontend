  ...
  return (
    <section className="min-h-[72vh] py-20">
      <div className="paddox-container">
        <SectionHeading eyebrow="PADDOX Route Ready" title="Register">
        ...
        <CommandCard className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-4 font-display text-4xl font-black uppercase tracking-[-.06em] text-white">Register Luxury Rebuild</h1>
